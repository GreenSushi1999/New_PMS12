            ...
            <div class="col-md-10">
                <div class="card shadow">
                    <div class="card-header">
                        <h3 class="card-title">Edit SuperVisory/Officer Level</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('edit-Supervalues') }}" method="POST">
                        {{ csrf_field() }}
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('edit-Supercriteria') }}" method="POST">
                        {{ csrf_field() }}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#indicatorSelect').change(function() {
                ...
                $.ajax({
                    url: '{{ route('get-Supercriteria') }}', // Replace with your actual route
                    method: 'GET',
                    data: {
